...
{	// Values in the table are as follows:
	...
	// Trash Quality
	{
		{ 2, 120, 100, 1700, 0}, // Cloth
		{ 2, 130, 200, 2000, 0}, // Leather
		{ 3, 130, 300, 2500, 1}, // Hardened Leather
		{ 4, 140, 450, 3500, 2}, // Mail	
		{ 4, 140, 450, 3500, 2}, // Scale
		{ 5, 160, 900, 6000, 3}, // Plate
	},
	// Poor Quality
	{
		{ 2, 140, 150, 1500, 0}, // Cloth
		{ 2, 150, 250, 1800, 0}, // Leather
		{ 3, 150, 400, 2300, 1}, // Hardened Leather
		{ 4, 160, 550, 3000, 2}, // Mail	
		{ 4, 160, 550, 3000, 2}, // Scale
		{ 5, 180, 1200, 5000, 3}, // Plate
	},
	// Ordinary Quality
	{
		{ 3, 155, 450, 1700, 0}, // Cloth
		{ 3, 165, 550, 2000, 0}, // Leather
		{ 4, 165, 900, 2500, 1}, // Hardened Leather
		{ 5, 175, 1600, 3500, 2}, // Mail	
		{ 5, 175, 1600, 3500, 2}, // Scale
		{ 6, 190, 1200, 5500, 3}, // Plate
	},
	// Good Quality
	{
		{ 4, 170, 100, 1900, 0}, // Cloth
		{ 4, 180, 200, 2200, 0}, // Leather
		{ 5, 180, 250, 2800, 1}, // Hardened Leather
		{ 6, 190, 600, 3800, 2}, // Mail	
		{ 6, 190, 600, 3800, 2}, // Scale
		{ 7, 210, 1200, 7500, 3}, // Plate
	},
	// Superb Quality
	{
...
do_zsave (CHAR_DATA * ch, char *arg, int cmd)
{
	...
	if (engine.in_build_mode ())
	  {
	    std::ostringstream oss;
	    oss << "cd " << engine.get_base_path() << "/regions; git add *.0; git commit -m \"Changes committed by ";
	    if (!ch || !ch->tname)
	      oss << "System";
	    else
	      oss << ch->tname;
