...
private:
	...
	void save_email() const {
		...
		update_flag_stream << "UPDATE forum_users" << " SET user_email = '"
				<< escaped_email << "'" << " WHERE user_id = " << id;
	...
	void save_password() const {
		...
		std::ostringstream update_flag_stream;
		update_flag_stream << "UPDATE forum_users" << " SET user_password = '"
				<< escaped_password << "'" << " WHERE user_id = " << id;
	...
	void save_last_ip() const {
		...
		std::ostringstream update_flag_stream;
		update_flag_stream << "UPDATE forum_users" << " SET user_last_ip = '"
				<< escaped_ip << "'" << " WHERE user_id = " << id;
	...
	void save_flags() const {
		std::ostringstream update_flag_stream;
		update_flag_stream << "UPDATE forum_users" << " SET account_flags = "
				<< flags << " WHERE user_id = " << id;
	...
	void save_rpp() const {
		std::ostringstream update_flag_stream;
		update_flag_stream << "UPDATE forum_users" << " SET roleplay_points = "
				<< roleplay_points << ", last_rpp = " << last_rpp
				<< " WHERE user_id = " << id;
	...
	void save_nominate() const {
		std::ostringstream update_flag_stream;
		update_flag_stream << "UPDATE forum_users" << " SET last_nominate = "
				<< last_nominate << " WHERE user_id = " << id;
	...
	void save_color_flag() const {
		std::ostringstream update_flag_stream;
		update_flag_stream << "UPDATE forum_users" << " SET user_color = "
				<< color << " WHERE user_id = " << id;
	...
	void save_sound_flag() const {
		std::ostringstream update_flag_stream;
		update_flag_stream << "UPDATE forum_users" << " SET user_sound = "
				<< sound << " WHERE user_id = " << id;
	...
	void save_guide_flag() const {
		std::ostringstream update_flag_stream;
		update_flag_stream << "UPDATE forum_users" << " SET user_guide = "
				<< guide << " WHERE user_id = " << id;
	...
	void save_newsletter_flag() const {
		std::ostringstream update_flag_stream;
		update_flag_stream << "UPDATE forum_users"
...
public:
	...
	void get_name_sql_safe(std::string& safe_name) const {
		...
		mysql_real_escape_string(database, escaped_name, name.c_str(),
				name_len);
	...
	void get_email_sql_safe(std::string& safe_email) const {
		...
		mysql_real_escape_string(database, escaped_email, email.c_str(),
				email_len);
	...
	void get_password_sql_safe(std::string& safe_password) const {
		...
		mysql_real_escape_string(database, escaped_password, password.c_str(),
				password_len);
